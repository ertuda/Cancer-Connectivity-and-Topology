...
# plots
#png(file='HighMeth_targets_Con_Neigh_AdeCar1_posCors.png',width=480,height=800)
tiff(file='HighMeth_targets_Con_Neigh_AdeCar1_posCors.tiff',width=3.35, height=6,units="in",res=600)
par(mfrow = c(2,2),mar=c(2.3,4,2.3,1))

save(randconcountan,file='Ade1randconsnormal.RData')
save(randconcountat,file='Ade1randconstumor.RData')
save(randconcountcn,file='Car1randconsnormal.RData')
save(randconcountct,file='Car1randconstumor.RData')

save(randneighcountan,file='Ade1randneighsnormal.RData')
save(randneighcountat,file='Ade1randneighstumor.RData')
save(randneighcountcn,file='Car1randneighsnormal.RData')
save(randneighcountct,file='Car1randneighstumor.RData')
...
plot(sample(52:148,length(randconcountcn),replace=TRUE),randconcountcn,xlim=c(0,350), 
     ...
     cex=0.05,xaxt='n', main='Car 1',ylab='number of connections',xlab='',cex.lab=1.25)
