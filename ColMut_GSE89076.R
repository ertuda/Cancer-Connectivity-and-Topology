...
save(randconcountan,file='Ade2randconsnormal_mut.RData')
save(randconcountat,file='Ade2randconstumor_mut.RData')
save(randconcountcn,file='Car2randconsnormal_mut.RData')
save(randconcountct,file='Car2randconstumor_mut.RData')

save(randneighcountan,file='Ade2randneighsnormal_mut.RData')
save(randneighcountat,file='Ade2randneighstumor_mut.RData')
save(randneighcountcn,file='Car2randneighsnormal_mut.RData')
save(randneighcountct,file='Car2randneighstumor_mut.RData')

# plots
#png(file='Mut_targets_Con_Neigh_GSE89076_PosCors.png',width=480,height=800)
tiff(file='Mut_targets_Con_Neigh_AdeCar2_posCors.tiff',width=3.35, height=6,units="in",res=600)
...
plot(sample(52:148,length(randconcountan),replace=TRUE),randconcountan,xlim=c(0,350), 
     ylim=c(0,max(max(randconcountan),max(randconcountat))),
...
text(100,1,paste0(as.character(loweran),'%'),cex=0.79)
...
text(250,1,paste0(as.character(lowerat),'%'),cex=0.79)
...
plot(sample(52:148,length(randconcountcn),replace=TRUE),randconcountcn,xlim=c(0,350), 
     ylim=c(0,max(max(randconcountcn),max(randconcountct))),
...
text(100,1,paste0(as.character(lowercn),'%'),cex=0.79)
...
text(100,1,paste0(as.character(loweran2),'%'),cex=0.79)
...
text(250,1,paste0(as.character(lowerat2),'%'),cex=0.79)
axis(1,at=c(100,250),labels=c('N','T'),tick=FALSE,cex.axis=1.15)

plot(sample(52:148,length(randneighcountcn),replace=TRUE),randneighcountcn,xlim=c(0,350), 
     ylim=c(0,max(max(randneighcountcn),max(randneighcountct))),
...
text(100,1,paste0(as.character(lowercn2),'%'),cex=0.79)
...
text(250,1,paste0(as.character(lowerct2),'%'),cex=0.79)
axis(1,at=c(100,250),labels=c('N','T'),tick=FALSE,cex.axis=1.15)
